# BALM-PPI Repository - Complete File Manifest
...
│
├── balm_ppi_config.yaml             # 65 lines
│   └── BALM-PPI with LoRA parameters
│
...
### Core Features
- ✅ Three model architectures (Baseline, Model-1, BALM-PPI)
...
**Created**: 2024
**Package**: BALM-PPI - Advanced Learning on Protein-Protein Interaction Networks
**Python Version**: 3.9+
