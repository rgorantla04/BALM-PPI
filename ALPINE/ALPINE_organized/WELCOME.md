# 🧬 ALPINE Project - Successfully Organized!
...
### Location
```
C:\Users\hs494\Desktop\ALPINE_organized/
```
...
- **3 training scripts** (Baseline, Model-1, ALPINE)
...
```bash
cd C:\Users\hs494\Desktop\ALPINE_organized
...
### 3. ALPINE (Best Performance 🏆)
- BALM with LoRA fine-tuning
- Full ESM-2 backbone adaptation
- Sequence-to-sequence processing
- **Run**: `python train_alpine.py --config configs/alpine_config.yaml --split cold_target`
...
git init
git add .
git commit -m "Organize ALPINE experiments for publication"
...
- ✅ `train_alpine.py` - ALPINE training

### Configuration
- ✅ `configs/baseline_config.yaml`
- ✅ `configs/model_1_config.yaml`
- ✅ `configs/alpine_config.yaml`
...
1. **Provide GitHub Link**: Point to your ALPINE repository
